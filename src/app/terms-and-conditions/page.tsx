  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <p>
          This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name <a href="https://evointerview.com">https://evointerview.com</a> ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
        </p>
        <p>
          The Platform is owned by Mr Yash Samir Ambaskar, a company incorporated under the Companies Act, 1956 with its registered office at 248, Gurumauli Apartment, Sahakar Nagar ,Nagpur ,India (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our')..
        </p>
        <p>
        ...
        <p>
          All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Nagpur and Maharashtra.
        </p>
        <p>
